										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													...
													<s:textfield id="visit_time" name="visit_time" cssClass="textbox" cssStyle="WIDTH: 80px" maxLength="50" theme="simple"/>
													</TD>
													
													<TD>到：</TD>
													<TD>
														<input type="text" id="visit_endtime" name="visit_endtime"  readonly="readonly" value="<s:date name="visit_endtime" format="yyyy-MM-dd"/>"/> 
								...
								<TR>
									<TD><SPAN id=pagelink>
											<DIV
												...
												,每页显示
												<select name="pageSize" onchange="toPage()">
